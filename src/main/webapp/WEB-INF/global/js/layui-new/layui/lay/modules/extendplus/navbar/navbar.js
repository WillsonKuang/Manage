    ...
    function getHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children.length > 0) {
                ulHtml += '<a href="javascript:;" style="width: 260px;">'; /*Willson：修改style="width: 260px;"*/
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ulHtml += '<dd>';
                    ulHtml += '<a href="javascript:;"  style="width: 240px;" data-url="' + data[i].children[j].href + '">';  /*Willson：修改style="width: 240px;"*/
                ...
                ulHtml += '<a href="javascript:;" style="width: 240px;" ' + dataUrl + '>';  /*Willson：修改style="width: 240px;"*/
                if (data[i].icon !== undefined && data[i].icon !== '') {
                    if (data[i].icon.indexOf('fa-') !== -1) {
                        ulHtml += '<i class="' + data[i].icon + '" aria-hidden="true"></i>';
                    } else {
